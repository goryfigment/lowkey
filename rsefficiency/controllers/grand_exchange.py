...
def decant_potions(request):
    ...
    data = {'base_url': get_base_url(), 'item_data': {}, 'high_alch': {}, 'result_list': data_list, 'result_type': 'decant_potions'}
    return render(request, 'grand_exchange.html', data)
...
def clean_herbs(request):
    ...
    data = {'base_url': get_base_url(), 'item_data': {}, 'high_alch': {}, 'result_list': data_list, 'result_type': 'clean_herbs'}
    return render(request, 'grand_exchange.html', data)
...
def barrows_repair(request):
    ...
    data = {'base_url': get_base_url(), 'item_data': {}, 'high_alch': {}, 'result_list': data_list, 'result_type': 'barrows_repair'}
    return render(request, 'grand_exchange.html', data)
...
def potion_making(request):
    ...
    data = {'base_url': get_base_url(), 'item_data': {}, 'high_alch': {}, 'result_list': data_list, 'result_type': 'potion_making'}
    return render(request, 'grand_exchange.html', data)
...
def unfinished_potions(request):
    ...
    data = {'base_url': get_base_url(), 'item_data': {}, 'high_alch': {}, 'result_list': data_list, 'result_type': 'unfinished_potions'}
    return render(request, 'grand_exchange.html', data)
